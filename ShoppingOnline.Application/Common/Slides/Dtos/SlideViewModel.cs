...
namespace ShoppingOnline.Application.Common.Slides.Dtos
{
    public class SlideViewModel
    {
        ...
        [StringLength(250)] [Required] public string Image { set; get; }

        [StringLength(250)] public string Url { set; get; }
        ...
        [StringLength(25)] [Required] public string GroupAlias { get; set; }
    }
}